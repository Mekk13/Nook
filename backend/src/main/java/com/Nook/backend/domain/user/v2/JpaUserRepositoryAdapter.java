...
public class JpaUserRepositoryAdapter implements IUserRepository {
    ...
    @Override
    public Optional<User> findById(String id) { return jpa.findById(id); }

    @Override
    public Optional<User> findByEmail(String email) { return jpa.findByEmailIgnoreCase(email); }

    @Override
    public Optional<User> findByUsername(String username) { return jpa.findByUsernameIgnoreCase(username); }

    @Override
    public List<User> findAll() { return jpa.findAll(); }

    @Override
    public void update(User user) { jpa.save(user); }
    ...
    @Override
    public boolean existsByUsername(String username) { return jpa.existsByUsernameIgnoreCase(username); }
}